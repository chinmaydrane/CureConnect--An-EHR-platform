...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // ✅ if patient, also store patientId separately for easy access
    ...
    <main className="min-h-dvh flex items-center justify-center p-6 bg-background">
      <Card className="w-full max-w-md border-border">
        <CardHeader className="pb-3">
          ...
          <CardTitle className="mt-3 text-center">Create your account</CardTitle>
          <CardDescription className="text-center">Choose a role to continue</CardDescription>
        </CardHeader>
        <CardContent>
